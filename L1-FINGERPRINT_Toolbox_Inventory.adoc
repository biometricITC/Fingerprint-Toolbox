= PAD-L1 Fingerprint Toolbox Inventory
:showtitle:
:revdate: 2024-08-02
...
|FP1-T.12
|Fingerprint Powder
|A granular powder containing fine granular particles (5-10 μm). 

*NOTE: Review the manufacturer's guidance for safety information about handling these materials.*
