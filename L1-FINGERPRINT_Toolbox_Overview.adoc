...
The commercial fingerprint scanner shuold be used to check the quality of the latent prints that are acquired, but not as the source of prints for use in the actual tests.
