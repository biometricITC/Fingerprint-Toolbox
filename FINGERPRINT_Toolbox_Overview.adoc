...
A mold is made from the target finger friction ridge pattern using a direct impression material (such as a direct impression material). The friction ridges of the enrolled finger are pressed into impression material to create a curved mold of the fingerprint.
