= Attack Fingerprint 01-01
:xrefstyle: short

== Attack type
Non-Newtonian fluid cast made from a mold.

=== Total Number of Species
This attack has *3* species to be tested.

== Overview
The evaluator captures a target user’s fingerprint with a commercial fingerprint scanner. Using the image from the scanner the evaluator produces a mold. A non-Newtonian fluid PAI is made from the mold and is presented to the TOE.
...
== Variations
All variants use the same cast recipe.
...
==== Recipe - mold
Utilize the M.3 dental impression material mold instructions from the Fingerprint Toolbox Inventory
...
Attack Potential values are shown in <<calculatedtable1-1>> (base attack), <<calculatedtable2-1>> (variant 1) and <<calculatedtable3-1>> (variant 2). Attack Potential values for Identification account for the time, expertise, etc. required to make the mold and the cast described in this attack. When selecting the mold / cast combination, consideration must be given to the ability to produce the mold separately from that needed for the cast. 
...
.Mold Attack Potential Fingerprint attack 01-01
[[moldtable1-1]]
...
.Cast Attack Potential Fingerprint attack 01-01
[[casttable1-1]]
[cols=".^2,.^2,^.^1",options="header",]
|===
|Factor 
...
.Calculated Attack Potential Fingerprint attack 02-01
[[calculatedtable2-1]]
[cols=".^2,.^2,^.^1,.^2,^.^1,^.^1",options="header",]
|===
|Factor 
...
.Mold Attack Potential Fingerprint attack 02-01
[[moldtable2-1]]
[cols=".^2,.^2,^.^1",options="header",]
|===
|Factor 
...
.Cast Attack Potential Fingerprint attack 02-01
[[casttable2-1]]
[cols=".^2,.^2,^.^1",options="header",]
|===
|Factor 
...
*Variant 2 - Dental impression material*

.Calculated Attack Potential Fingerprint attack 03-01
[[calculatedtable3-1]]
[cols=".^2,.^2,^.^1,.^2,^.^1,^.^1",options="header",]
|===
|Factor 
...
.Mold Attack Potential Fingerprint attack 03-01
[[moldtable3-1]]
[cols=".^2,.^2,^.^1",options="header",]
|===
|Factor 
...
.Cast Attack Potential Fingerprint attack 03-01
[[casttable3-1]]
[cols=".^2,.^2,^.^1",options="header",]
|===
|Factor 
