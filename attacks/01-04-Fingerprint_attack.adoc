...
.Calculated Attack Potential 2D Fingerprint attack 01-04
[[calculatedtable]]
...
.Mold Attack Potential 2D Fingerprint attack 01-04
[[moldtable]]
...
.Cast Attack Potential 2D Fingerprint attack 01-04
[[casttable]]
[cols=".^2,.^2,^.^1",options="header",]
|===
|Factor 
