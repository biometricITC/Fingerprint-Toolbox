= Attack L1-Fingerprint FP1-02-xx
:xrefstyle: short
...
.Calculated Attack Potential Fingerprint attack FP1-02-xx
[[calculatedtable]]
...
.Mold Attack Potential Fingerprint attack FP1-02-xx
[[moldtable]]
...
.Cast Attack Potential Fingerprint attack FP1-02-xx
[[casttable]]
[cols=".^2,.^2,^.^1",options="header",]
|===
|Factor 
