...
== Overview
The evaluator makes a mold from dental impression material using the test subject’s finger. A non-Newtonian fluid PAI is made from the dental impression mold and is presented to the TOE.
