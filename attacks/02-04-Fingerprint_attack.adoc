= Attack 2D Fingerprint 02-04

== Attack type
Silicone cast made from printed circuit board (PCB) mold.
...
.Calculated Attack Potential 2D Fingerprint attack 02-04
[[calculatedtable]]
...
.Mold Attack Potential 2D Fingerprint attack 02-04
[[moldtable]]
...
.Cast Attack Potential 2D Fingerprint attack 02-04
[[casttable]]
[cols=".^2,.^2,^.^1",options="header",]
|===
|Factor 
