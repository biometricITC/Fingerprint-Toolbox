= Attack 2D Fingerprint 01-03

== Attack type
A gelatin / glycerin mix cast made from transparency material mold.

=== Total Number of Species
This attack has *1* species to be tested.

== Overview
The evaluator captures a target user’s fingerprint with a commercial fingerprint scanner. Using the image from the scanner the evaluator produces a laser printer transparency mold. A gelatin with glycerin PAI is made from the laser printer transparency mold and is presented to the TOE.
...
.Calculated Attack Potential 2D Fingerprint attack 01-03
[[calculatedtable]]
...
.Mold Attack Potential 2D Fingerprint attack 01-03
[[moldtable]]
...
.Cast Attack Potential 2D Fingerprint attack 01-03
[[casttable]]
[cols=".^2,.^2,^.^1",options="header",]
|===
|Factor 
