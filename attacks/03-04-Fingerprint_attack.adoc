...
== Overview
The evaluator makes a mold from dental impression material using the test subject’s finger. A silicone PAI is made from the dental impression mold and is presented to the TOE.
...
.Calculated Attack Potential 3D Fingerprint attack 03-04
[[calculatedtable]]
...
.Mold Attack Potential 3D Fingerprint attack 03-04
[[moldtable]]
...
.Cast Attack Potential 3D Fingerprint attack 03-04
[[casttable]]
[cols=".^2,.^2,^.^1",options="header",]
|===
|Factor 
